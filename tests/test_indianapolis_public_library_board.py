...
from city_scrapers.spiders.indianapolis_public_library_board import (
    IndianapolisPublicLibraryBoardSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "indianapolis_public_library_board.html"),
    url="https://www.indypl.org/about-the-library/board-meeting-times-committees",
)
spider = IndianapolisPublicLibraryBoardSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "indianapolis_public_library_board/202301171430/x/indianapolis_public_library_board_of_trustees"  # noqa
    )
