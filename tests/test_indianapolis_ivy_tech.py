...
from city_scrapers.spiders.indianapolis_ivy_tech import IndianapolisIvyTechSpider

test_response = file_response(
    join(dirname(__file__), "files", "indianapolis_ivy_tech.html"),
    url="https://www.ivytech.edu/about-ivy-tech/college-operations/state-board-of-trustees/",  # noqa
)
spider = IndianapolisIvyTechSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "indianapolis_ivy_tech/202302010000/x/ivy_tech_community_college_state_board_of_trustees"  # noqa
    )
