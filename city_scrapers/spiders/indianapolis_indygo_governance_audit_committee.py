...
class IndianapolisIndygoGovernanceAuditCommitteeSpider(CityScrapersSpider):
    name = "indianapolis_indygo_governance_audit_committee"
    ...
    def parse(self, response):
        ...
        needs.
        """
        for item in response.css(".content-section:nth-child(8) ul li"):
            meeting = Meeting(
    ...
    def _parse_title(self, item):
        title = "IndyGo Governance Audit Committee"
        return title
    ...
    def _parse_time_notes(self, item):
        ...
        return "Governance Audit Committee meetings are set for 1:00PM unless otherwise noted in meeting description. Please double check the website before the meeting date."  # noqa
