...
from city_scrapers.spiders.indianapolis_indygo_service_committee import (
    IndianapolisIndygoServiceCommitteeSpider,
)

test_response = file_response(
    join(dirname(__file__), "files", "indianapolis_indygo_service_committee.html"),
    url="https://www.indygo.net/about-indygo/board-of-directors/",
)
spider = IndianapolisIndygoServiceCommitteeSpider()
...
def test_id():
    assert (
        parsed_items[0]["id"]
        == "indianapolis_indygo_service_committee/202301191000/x/indygo_service_committee"  # noqa
    )
